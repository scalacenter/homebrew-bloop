class Bloop < Formula
  ...
  version "1.5.11"
  url "https://github.com/scalacenter/bloop/releases/download/v1.5.11/bloop-coursier.json"
  sha256 "ed0d09bf3e9dffcb31bfcbbac9380f601483c65084df909db44cb677e4d8c34f"
  ...
  resource "bash_completions" do
    url "https://github.com/scalacenter/bloop/releases/download/v1.5.11/bash-completions"
    sha256 "da6b7ecd4109bd0ff98b1c452d9dd9d26eee0d28ff604f6c83fb8d3236a6bdd1"
  end

  resource "zsh_completions" do
    url "https://github.com/scalacenter/bloop/releases/download/v1.5.11/zsh-completions"
    sha256 "58d32c3f005f7791237916d1b5cd3a942115236155a0b7eba8bf36391d06eff7"
  end

  resource "fish_completions" do
    url "https://github.com/scalacenter/bloop/releases/download/v1.5.11/fish-completions"
