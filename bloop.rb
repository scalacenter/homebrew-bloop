class Bloop < Formula
  ...
  version "2.1.1"
  url "https://github.com/scalacenter/bloop/releases/download/v2.1.1/bloop-coursier.json"
  sha256 "647de09c3e0d740fa5c1961ef8566db274724e33f48f315101c4741287a31447"
  ...
  resource "bash_completions" do
    url "https://github.com/scalacenter/bloop/releases/download/v2.1.1/bash-completions"
    sha256 "da6b7ecd4109bd0ff98b1c452d9dd9d26eee0d28ff604f6c83fb8d3236a6bdd1"
  end

  resource "zsh_completions" do
    url "https://github.com/scalacenter/bloop/releases/download/v2.1.1/zsh-completions"
    sha256 "58d32c3f005f7791237916d1b5cd3a942115236155a0b7eba8bf36391d06eff7"
  end

  resource "fish_completions" do
    url "https://github.com/scalacenter/bloop/releases/download/v2.1.1/fish-completions"
