class Bloop < Formula
  ...
  version "2.1.0"
  url "https://github.com/scalacenter/bloop/releases/download/v2.1.0/bloop-coursier.json"
  sha256 "a3571fee9ae1ea0a620e5cb39596b763035d7fe517254279736c449cda75d7df"
  ...
  resource "bash_completions" do
    url "https://github.com/scalacenter/bloop/releases/download/v2.1.0/bash-completions"
    sha256 "da6b7ecd4109bd0ff98b1c452d9dd9d26eee0d28ff604f6c83fb8d3236a6bdd1"
  end

  resource "zsh_completions" do
    url "https://github.com/scalacenter/bloop/releases/download/v2.1.0/zsh-completions"
    sha256 "58d32c3f005f7791237916d1b5cd3a942115236155a0b7eba8bf36391d06eff7"
  end

  resource "fish_completions" do
    url "https://github.com/scalacenter/bloop/releases/download/v2.1.0/fish-completions"
