class Bloop < Formula
  ...
  version "2.0.18"
  url "https://github.com/scalacenter/bloop/releases/download/v2.0.18/bloop-coursier.json"
  sha256 "a75317e7a8a2917dc2fac1000eda05b56d2475393f94c3ce4360f300656189b7"
  ...
  resource "bash_completions" do
    url "https://github.com/scalacenter/bloop/releases/download/v2.0.18/bash-completions"
    sha256 "da6b7ecd4109bd0ff98b1c452d9dd9d26eee0d28ff604f6c83fb8d3236a6bdd1"
  end

  resource "zsh_completions" do
    url "https://github.com/scalacenter/bloop/releases/download/v2.0.18/zsh-completions"
    sha256 "58d32c3f005f7791237916d1b5cd3a942115236155a0b7eba8bf36391d06eff7"
  end

  resource "fish_completions" do
    url "https://github.com/scalacenter/bloop/releases/download/v2.0.18/fish-completions"
