class Bloop < Formula
  ...
  version "1.4.9"
  url "https://github.com/scalacenter/bloop/releases/download/v1.4.8-138-g08b4623/bloop-coursier.json"
  sha256 "c453d4a9d87c33a46ff2e11796ed67d0d285030e2b9b37a29e0933c0509a097a"
  bottle :unneeded
  ...
  resource "bash_completions" do
    url "https://github.com/scalacenter/bloop/releases/download/v1.4.8-138-g08b4623/bash-completions"
    sha256 "da6b7ecd4109bd0ff98b1c452d9dd9d26eee0d28ff604f6c83fb8d3236a6bdd1"
  end

  resource "zsh_completions" do
    url "https://github.com/scalacenter/bloop/releases/download/v1.4.8-138-g08b4623/zsh-completions"
    sha256 "58d32c3f005f7791237916d1b5cd3a942115236155a0b7eba8bf36391d06eff7"
  end

  resource "fish_completions" do
    url "https://github.com/scalacenter/bloop/releases/download/v1.4.8-138-g08b4623/fish-completions"
