class Bloop < Formula
  ...
  version "1.5.12"
  url "https://github.com/scalacenter/bloop/releases/download/v1.5.12/bloop-coursier.json"
  sha256 "eb766a7bff387badd08b7c9b7981a45a0e7d27d1d497c45a40a6cc0bb3e6292a"
  ...
  resource "bash_completions" do
    url "https://github.com/scalacenter/bloop/releases/download/v1.5.12/bash-completions"
    sha256 "da6b7ecd4109bd0ff98b1c452d9dd9d26eee0d28ff604f6c83fb8d3236a6bdd1"
  end

  resource "zsh_completions" do
    url "https://github.com/scalacenter/bloop/releases/download/v1.5.12/zsh-completions"
    sha256 "58d32c3f005f7791237916d1b5cd3a942115236155a0b7eba8bf36391d06eff7"
  end

  resource "fish_completions" do
    url "https://github.com/scalacenter/bloop/releases/download/v1.5.12/fish-completions"
